...
screen -S cpuinter srun --partition=compchemq --qos=compchem --nodes=1 --ntasks-per-node=1 --cpus-per-task=1 --ntasks-per-socket=1 --gres=gpu:3 --mem=10G --time=12:00:00 --pty bash